        ...
        <form action="{{ route('vendors.update', $vendor) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="contact" name="contact" value="{{ old('contact', $vendor->contact) }}">
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="tax_id" name="tax_id" value="{{ old('tax_id', $vendor->tax_id) }}">
                </div>
                <div class="col-md-12 mb-3">
                    <label for="services" class="form-label">Services</label>
                    <textarea class="form-control" id="services" name="services" rows="2">{{ old('services', $vendor->services) }}</textarea>
                </div>
                <div class="col-md-12 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="billing_terms" name="billing_terms" value="{{ old('billing_terms', $vendor->billing_terms) }}" placeholder="e.g., Net 30, Net 60">
                </div>
                <div class="col-md-6 mb-3">
