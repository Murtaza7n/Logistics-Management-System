...
@section('page-title', 'System Optimization')
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('system.run-optimization') }}" onsubmit="return confirm('Are you sure you want to run system optimization?');">
            @csrf
            <div class="mb-4">
