<?php $__env->startSection('title', 'Designation Codes'); ?>
<?php $__env->startSection('page-title', 'Designation Codes'); ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong><?php echo e($designation->code); ?></strong></td>
                        <td><?php echo e($designation->name); ?></td>
                        <td><?php echo e($designation->description ?? 'N/A'); ?></td>
                        <td>
                            <span class="badge badge-<?php echo e($designation->is_active ? 'primary' : 'secondary'); ?>">
                                <?php echo e($designation->is_active ? 'Active' : 'Inactive'); ?>

                            </span>
                        </td>
                        <td><?php echo e($designation->employees()->count()); ?></td>
                        <td>
                            <div class="btn-group" role="group">
                                <button type="button" 
                                        class="btn btn-sm btn-outline-primary" 
                                        onclick="editDesignation(<?php echo e($designation->id); ?>, '<?php echo e($designation->code); ?>', '<?php echo e($designation->name); ?>', '<?php echo e(addslashes($designation->description ?? '')); ?>', <?php echo e($designation->is_active ? 'true' : 'false'); ?>)"
                                        title="Edit Designation">
                                    Edit
                                </button>
                                <form action="<?php echo e(route('payroll.designations.delete', $designation->id)); ?>" 
                                      method="POST" 
                                      class="d-inline" 
...
function editDesignation(id, code, name, description, isActive) {
    ...
    form.action = '<?php echo e(url('payroll/designations')); ?>/' + id;
...
document.getElementById('addDesignationModal').addEventListener('hidden.bs.modal', function() {
    ...
    form.action = '<?php echo e(route('payroll.designations.store')); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Logistics-Management-System/resources/views/payroll/designations.blade.php ENDPATH**/ ?>