<?php $__env->startSection('title', 'Stock in Transit Report'); ?>
<?php $__env->startSection('page-title', 'Stock in Transit Report'); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('reports.stock-in-transit')); ?>" class="row g-3">
            <div class="col-md-3">
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"> Stock in Transit (<?php echo e($shipments->count()); ?> records)</h5>
    </div>
    <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Logistics-Management-System/resources/views/reports/stock_in_transit.blade.php ENDPATH**/ ?>