<?php $__env->startSection('title', 'Loan Master File'); ?>
<?php $__env->startSection('page-title', 'Loan Master File'); ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong><?php echo e($loan->employee->name ?? 'N/A'); ?></strong></td>
                        <td><?php echo e($loan->loan_type); ?></td>
                        <td>Rs.<?php echo e(number_format($loan->loan_amount, 2)); ?></td>
                        <td>Rs.<?php echo e(number_format($loan->installment_amount, 2)); ?></td>
                        <td><?php echo e($loan->paid_installments); ?>/<?php echo e($loan->total_installments); ?></td>
                        <td>
                            <span class="badge badge-<?php echo e($loan->status === 'active' ? 'primary' : ($loan->status === 'completed' ? 'secondary' : 'dark')); ?>">
                                <?php echo e(ucfirst($loan->status)); ?>

                            </span>
                        </td>
                        <td><?php echo e($loan->start_date->format('Y-m-d')); ?></td>
                        <td>
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="editLoan(<?php echo e($loan->id); ?>)">
                                
                            </button>
                            <form action="<?php echo e(route('payroll.loans.delete', $loan->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                                <?php echo csrf_field(); ?>
...
function editLoan(id) {
    ...
    document.getElementById('loanForm').action = '<?php echo e(url('payroll/loans')); ?>/' + id;
...
document.getElementById('addLoanModal').addEventListener('hidden.bs.modal', function() {
    ...
    document.getElementById('loanForm').action = '<?php echo e(route('payroll.loans.store')); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Logistics-Management-System/resources/views/payroll/loans.blade.php ENDPATH**/ ?>