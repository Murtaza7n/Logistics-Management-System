...
return [
    ...
    */
    ...
    | rid of old sessions from storage. Here are the chances that it will happen
    ...
    */
    ...
    | access the value of the cookie and the cookie will only be accessible
    | through the HTTP protocol. You are free to modify this option if needed.
    |
    */
